...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    //Vérification de la requete suivant la méthode POST 
    ...
    <div class="layout">
        ...
        <div class="layout__main">
            <div class="profile-header">
                ...
                <div class="profile-details">
                    <!-- <img class="profile-avatar" src="../../asset/profile-avatar.png" alt="Avatar">-->
                    <?php
                ...
                ?>
                    <button type="button" class="login-btn" onclick="window.location.href='editView.php'">Edit Profil</button>
                </div>
            </div>

            <div class="profile-navigation">
                <button type="button" onclick="window.location.href='retweetView.php'">Retweet</button>
                <button type="button" onclick="window.location.href='amie.php'">Followers</button>
        ...
        <div  id="tweetContainer">
                <div class="tweet-wrapper">
                    <?php
                    $tweets = $controller->afficheTweet();
                    if (!empty($tweets)) {
